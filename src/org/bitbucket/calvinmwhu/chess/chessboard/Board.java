...
public abstract class Board {
    ...
    public boolean checkmated(String color) {
        HashMap<String, Piece> target = color.equals(white) ? whitePlayer : blackPlayer;
        HashMap<String, Piece> attacker = color.equals(black) ? whitePlayer : blackPlayer;
        LinkedList<Square> neighbours = target.get("King").getNeighbours();

        //to do: check if target king is checkmate!!
        gameEnded = true;
        return false;
    }
